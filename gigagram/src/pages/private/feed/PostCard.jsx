      ...
      <CardHeader
        avatar={
          <Avatar
            ...
            src={item && item.user ? item.user.avatar : "https://plus.unsplash.com/premium_photo-1669411189365-21d567c0e7bd?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
            alt="my avatar"
            sx={{ width: 60, height: 60 }}
            aria-label="recipe"
          ></Avatar>
        }
        title={item && item.user ? item.user.username : "username"}
      />
